...
model_init(Model* m, MeshInfo *mesh)
{
    ...
    texture_load(&(m->diff),"../assets/red.png");
    texture_load(&(m->spec),"../assets/white.png");
...
local_persist f32 cube_data[] = {
  // position            normal        tex coords
   ...
   -1.0f, 1.0f, 1.0f,  -1.f,0.f,0.f,  1.f,1.f,
    ...
    -1.0f, 1.0f, 1.0f, 0.f,1.f,0.f,   0.f,1.f, //fadjfhasdkjfhas
    -1.0f,-1.0f, 1.0f, 0.f,1.f,0.f,   0.f,0.f,
    1.0f,-1.0f, 1.0f,  0.f,1.f,0.f,   1.f,0.f,
...
model_init_cube(Model* m)
{
    ...
    texture_load(&(m->spec),"../assets/texture.tga");
